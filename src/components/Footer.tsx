...
const footerLinks = {
  ...
  Developer: [
    { name: "GitHub Profile", href: "https://github.com/mericcintosun", external: true },
    { name: "This Repository", href: "https://github.com/mericcintosun/assignment-sui-workshop", external: true },
    { name: "Sui dApp Kit", href: "https://sdk.mystenlabs.com/dapp-kit", external: true },
    { name: "Enoki", href: "https://portal.enoki.mystenlabs.com/", external: true },
  ],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              >
                <img src="/logo.png" alt="NEXUSUI" className="w-8 h-8 rounded-full" />
              </motion.div>
              <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              A comprehensive ecosystem of innovative dApps built on the Sui blockchain, 
              connecting the future of decentralized applications.
            </p>
          ...
          {/* dApps Links */}
          <div>
            <h4 className="text-foreground font-semibold mb-4">dApps</h4>
          ...
          {/* Developer Links */}
          <div>
            <h4 className="text-foreground font-semibold mb-4">Developer</h4>
            <ul className="space-y-2">
